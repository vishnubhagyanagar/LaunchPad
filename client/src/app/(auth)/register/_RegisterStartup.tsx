...
export default function RegisterStartup() {
  ...
  const [patentVerified,setPatentVerified]=useState<boolean>();// have changed the patent to true for testing then now to false
...
const validatePatentId = async () => {
  ...
  try {
    ...
    const patentTitle = data.organic_results?.[0]?.title;

    if (patentTitle &&patentTitle===patentname) {
      ...
      setErrors((prev) => ({
        ...prev,
        patentApplicationNumber: "Invalid Patent ",
      }));
          ...
          <div className="mt-10 w-full bg-white shadow-2xl rounded-lg overflow-hidden">
            ...
            >
              ...
              <div className="mb-4">
                ...
                {!otpverified? <Text style={{color:"red"}}>Otp Not Verified</Text>:<Text style={{color:"green"}}>Otp Verified!!</Text>}
              </div>
              <div className="mb-4">
                <label
                  className="block text-gray-700 font-bold mb-1 px-1"
              ...
              <div className="mb-4 col-span-2">
                ...
                <Text style={{ color: errors?.patentApplicationNumber ? "red" : patentVerified ? "green" : "red" }}>
